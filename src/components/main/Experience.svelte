    ...
    <div class="w-full md:w-9/12 lg:w-8/12 mx-auto">
      ...
      <ul id="my-certificate" class="mt-12">
        <li class="mb-8 list-item-custom-cert">
          <div class="ml-20">
            <a
              href="https://www.credly.com/badges/1f9dda85-c4f3-49c4-a9a2-fb395fad9f52"
              rel="noopener noreferrer"
              class="mb-8 text-2xl md:text-2xl block roboto-slab lg:text-4xl"
        ...
        <li class="mb-8 list-item-custom-cert">
          <div class="ml-20">
            <a
              href="https://www.credly.com/badges/bb44b52c-0ceb-42bc-8305-0ca7b7e3c6fb"
              rel="noopener noreferrer"
              class="mb-8 text-2xl md:text-2xl block roboto-slab lg:text-4xl"
              >AWS certified developers associate</a
            >
            <hr class="border-site" />
          </div>
        </li>
        <li class="mb-8 list-item-custom-cert">
          <div class="ml-20">
            <a
              href="https://www.credly.com/badges/e5d9637c-cbec-4072-86e3-f56a3f4a939c"
              rel="noopener noreferrer"
              class="mb-8 text-2xl md:text-2xl block roboto-slab lg:text-4xl"
